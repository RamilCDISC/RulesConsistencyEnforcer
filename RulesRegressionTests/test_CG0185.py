...
RULE_JSON_FILE = "published_rules/CG0185/CG0185.json"
DATASET_PATH = "json_datasets/CG0185/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000169', 1, 'CG0185', None, 'Verify that LBTOXGR value is not from a numeric scale', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
