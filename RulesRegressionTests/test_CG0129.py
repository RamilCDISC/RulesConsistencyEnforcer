...
RULE_JSON_FILE = "published_rules/CG0129/CG0129.json"
DATASET_PATH = "json_datasets/CG0129/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000377', 1, 'CG0129', None, 'DM.ARMCD must equal DM.ACTARMCD when subject is either a screen failure or not assigned to treatment', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
