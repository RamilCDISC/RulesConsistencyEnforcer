...
RULE_JSON_FILE = "published_rules/CG0353/CG0353.json"
DATASET_PATH = "json_datasets/CG0353/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000242', 1, 'CG0353', None, '--EXCLFL must never be used in SDTM-based human trials', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
