...
RULE_JSON_FILE = "published_rules/CG0024/CG0024.json"
DATASET_PATH = "json_datasets/CG0024/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000571', 1, 'CG0024', None, 'LNKID variable is only found in one domain.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
