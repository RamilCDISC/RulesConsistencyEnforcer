...
RULE_JSON_FILE = "published_rules/CG0389/CG0389.json"
DATASET_PATH = "json_datasets/CG0389/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000124', 1, 'CG0389', None, 'AESCONG is completed, but not equal to "N" or "Y"', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
