...
RULE_JSON_FILE = "published_rules/CG0273/CG0273.json"
DATASET_PATH = "json_datasets/CG0273/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000562', 1, 'CG0273', None, 'A record exists in TS where TSPARMCD = HLTSUBJI and TSVAL = N but TSVAL for TSPARMCD = TDIGRP is empty.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
