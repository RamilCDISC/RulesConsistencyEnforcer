...
RULE_JSON_FILE = "published_rules/CG0394/CG0394.json"
DATASET_PATH = "json_datasets/CG0394/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000129', 1, 'CG0394', None, 'AESOD is completed, but not equal to "N" or "Y"', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
