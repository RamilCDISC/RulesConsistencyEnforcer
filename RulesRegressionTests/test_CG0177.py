...
RULE_JSON_FILE = "published_rules/CG0177/CG0177.json"
DATASET_PATH = "json_datasets/CG0177/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000025', 1, 'CG0177', None, 'IESTRESC is not equal to IEORRES', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
