...
RULE_JSON_FILE = "published_rules/CG0395/CG0395.json"
DATASET_PATH = "json_datasets/CG0395/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000130', 1, 'CG0395', None, 'AESMIE is completed, but not equal to "N" or "Y"', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
