...
RULE_JSON_FILE = "published_rules/CG0146/CG0146.json"
DATASET_PATH = "json_datasets/CG0146/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000380', 1, 'CG0146', None, 'RFSTDTC must not be null when ACTARM is not in (Screen Failure, Not Assigned, Not Treated)', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
