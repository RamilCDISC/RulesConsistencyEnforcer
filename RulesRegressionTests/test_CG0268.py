...
RULE_JSON_FILE = "published_rules/CG0268/CG0268.json"
DATASET_PATH = "json_datasets/CG0268/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000154', 1, 'CG0268', None, 'TSSEQ is not unique within TSPARMCD', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
