...
RULE_JSON_FILE = "published_rules/CG0057/CG0057.json"
DATASET_PATH = "json_datasets/CG0057/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000084', 1, 'CG0057', None, '--ENTPT exists in a dataset, but --ENRTPT does not exist.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
