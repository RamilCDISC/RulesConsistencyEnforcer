...
RULE_JSON_FILE = "published_rules/CG0142/CG0142.json"
DATASET_PATH = "json_datasets/CG0142/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000378', 1, 'CG0142', None, 'RFENDTC must not be null when ACTARM is a value other than Screen Failure, Not Assigned, or Not Treated', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
