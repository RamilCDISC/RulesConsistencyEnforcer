...
RULE_JSON_FILE = "published_rules/CG0293/CG0293.json"
DATASET_PATH = "json_datasets/CG0293/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000155', 1, 'CG0293', None, 'ARMCD is not in TA.ARMCD', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
