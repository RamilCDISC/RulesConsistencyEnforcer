...
RULE_JSON_FILE = "published_rules/CG0164/CG0164.json"
DATASET_PATH = "json_datasets/CG0164/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000090', 1, 'CG0164', None, 'RDOMAIN has a missing value but IDVAR has a non-missing value', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
