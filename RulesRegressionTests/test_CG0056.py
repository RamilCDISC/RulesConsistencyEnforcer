...
RULE_JSON_FILE = "published_rules/CG0056/CG0056.json"
DATASET_PATH = "json_datasets/CG0056/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000081', 1, 'CG0056, TIG0330', None, '--STAT is present when --PRESP is not present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
