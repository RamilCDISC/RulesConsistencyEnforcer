...
RULE_JSON_FILE = "published_rules/CG0279/CG0279.json"
DATASET_PATH = "json_datasets/CG0279/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000497', 1, 'CG0279', None, 'A record exists in TS where TSPARMCD = STYPE and TSVAL = INTERVENTIONAL but TSVAL for TSPARMCD = PCLAS is empty when PCLAS is applicable.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
