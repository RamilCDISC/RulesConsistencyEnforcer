...
RULE_JSON_FILE = "published_rules/CG0086/CG0086.json"
DATASET_PATH = "json_datasets/CG0086/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000018', 1, 'CG0086', None, '--OCCUR is blank when --PRESP is equal to "Y" and --STAT is not provided.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
