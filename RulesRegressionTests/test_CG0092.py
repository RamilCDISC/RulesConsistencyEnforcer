...
RULE_JSON_FILE = "published_rules/CG0092/CG0092.json"
DATASET_PATH = "json_datasets/CG0092/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000167', 1, 'CG0092', None, '--TPTREF must be present when --ELTM is present in a dataset', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
