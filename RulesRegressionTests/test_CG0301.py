...
RULE_JSON_FILE = "published_rules/CG0301/CG0301.json"
DATASET_PATH = "json_datasets/CG0301/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000077', 1, 'CG0301', None, 'TRDIR is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
