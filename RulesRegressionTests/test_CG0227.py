...
RULE_JSON_FILE = "published_rules/CG0227/CG0227.json"
DATASET_PATH = "json_datasets/CG0227/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000177', 1, 'CG0227', None, 'DM.RFENDTC is empty, but --ENRF is completed.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
