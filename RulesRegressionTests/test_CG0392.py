...
RULE_JSON_FILE = "published_rules/CG0392/CG0392.json"
DATASET_PATH = "json_datasets/CG0392/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000127', 1, 'CG0392', None, 'AESHOSP is completed, but not equal to "N" or "Y"', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
