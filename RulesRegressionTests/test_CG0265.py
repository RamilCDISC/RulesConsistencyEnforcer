...
RULE_JSON_FILE = "published_rules/CG0265/CG0265.json"
DATASET_PATH = "json_datasets/CG0265/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000152', 1, 'CG0265', None, 'There is not a one-to-one relationship between TSVAL and TSVALCD', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
