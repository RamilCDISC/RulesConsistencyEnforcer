...
RULE_JSON_FILE = "published_rules/CG0037/CG0037.json"
DATASET_PATH = "json_datasets/CG0037/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000362', 1, 'CG0037', None, 'Primary analysis was used but --SOCCD and --BDSYCD are not equal', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
