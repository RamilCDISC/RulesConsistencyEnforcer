...
RULE_JSON_FILE = "published_rules/CG0127/CG0127.json"
DATASET_PATH = "json_datasets/CG0127/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000543', 1, 'CG0127', None, 'ARMCD does not equal ACTARMCD when subject is either a screen failure or not assigned to treatment', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
