...
RULE_JSON_FILE = "published_rules/CG0049/CG0049.json"
DATASET_PATH = "json_datasets/CG0049/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000268', 1, 'CG0049', None, '--DECOD and --PTCD do not have a one-to-one relationship', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
