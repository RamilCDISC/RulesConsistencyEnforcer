...
RULE_JSON_FILE = "published_rules/CG0396/CG0396.json"
DATASET_PATH = "json_datasets/CG0396/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000131', 1, 'CG0396', None, 'AECONTRT is completed, but not equal to "N" or "Y"', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
