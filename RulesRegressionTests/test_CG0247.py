...
RULE_JSON_FILE = "published_rules/CG0247/CG0247.json"
DATASET_PATH = "json_datasets/CG0247/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000144', 1, 'CG0247', None, 'TAETORD is not unique within ARM', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
