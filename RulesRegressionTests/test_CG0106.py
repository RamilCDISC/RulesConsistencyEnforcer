...
RULE_JSON_FILE = "published_rules/CG0106/CG0106.json"
DATASET_PATH = "json_datasets/CG0106/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000089', 1, 'CG0106', None, 'Value for --VAMT is populated, when --TRTV is NULL.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
