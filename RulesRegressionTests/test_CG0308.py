...
RULE_JSON_FILE = "published_rules/CG0308/CG0308.json"
DATASET_PATH = "json_datasets/CG0308/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000180', 1, 'CG0308, TIG0483', None, 'Domain value length is not equal 2.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
