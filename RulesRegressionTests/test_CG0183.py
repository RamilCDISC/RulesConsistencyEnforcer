...
RULE_JSON_FILE = "published_rules/CG0183/CG0183.json"
DATASET_PATH = "json_datasets/CG0183/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000299', 1, 'CG0183', None, 'LBORRES is not a numeric result/empty and LBSTNRHI is not empty.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
