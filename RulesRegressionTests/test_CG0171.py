...
RULE_JSON_FILE = "published_rules/CG0171/CG0171.json"
DATASET_PATH = "json_datasets/CG0171/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000259', 1, 'CG0171', 'FB0613', "SSSTRESC = 'DEAD', but SSDTC < DM.DTHDTC.", 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
