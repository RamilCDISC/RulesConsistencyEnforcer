...
RULE_JSON_FILE = "published_rules/CG0089/CG0089.json"
DATASET_PATH = "json_datasets/CG0089/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000016', 1, 'CG0089', None, '--PRESP should be populated as "Y" when --OCCUR is provided.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
