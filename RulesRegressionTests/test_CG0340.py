...
RULE_JSON_FILE = "published_rules/CG0340/CG0340.json"
DATASET_PATH = "json_datasets/CG0340/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000198', 1, 'CG0340', None, '--SCAT is equal to --BODSYS.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
