...
RULE_JSON_FILE = "published_rules/CG0108/CG0108.json"
DATASET_PATH = "json_datasets/CG0108/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000091', 1, 'CG0108', None, 'Value for --VAMTU is populated, when --TRTV is NULL.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
