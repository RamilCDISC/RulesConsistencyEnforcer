...
RULE_JSON_FILE = "published_rules/CG0310/CG0310.json"
DATASET_PATH = "json_datasets/CG0310/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000182', 1, 'CG0310, SEND2, TIG0128, TIG0485', None, 'Variable name length is greater than 8.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
