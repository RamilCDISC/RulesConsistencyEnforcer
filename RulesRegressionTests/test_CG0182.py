...
RULE_JSON_FILE = "published_rules/CG0182/CG0182.json"
DATASET_PATH = "json_datasets/CG0182/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000298', 1, 'CG0182', None, 'LBORRES is not a numeric result/empty and LBSTNRLO is not empty.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
