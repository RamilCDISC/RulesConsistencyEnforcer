...
RULE_JSON_FILE = "published_rules/CG0116/CG0116.json"
DATASET_PATH = "json_datasets/CG0116/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000098', 1, 'CG0116', None, '--DIR variable is present, when --LOC variable does not exist in a dataset.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
