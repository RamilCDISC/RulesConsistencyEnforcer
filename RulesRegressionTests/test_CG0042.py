...
RULE_JSON_FILE = "published_rules/CG0042/CG0042.json"
DATASET_PATH = "json_datasets/CG0042/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000266', 1, 'CG0042', None, 'If AESER = "N" then none of the seriousness criteria (AESCAN, AESCONG, AESDISAB, AESDTH, AESHOSP, AESLIFE, AESOD, AESMIE) could be equal to "Y".', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
