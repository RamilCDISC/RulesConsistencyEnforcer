...
RULE_JSON_FILE = "published_rules/CG0344/CG0344.json"
DATASET_PATH = "json_datasets/CG0344/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000162', 1, 'CG0344', None, "--TESTCD is equal to 'MULTIPLE'", 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
