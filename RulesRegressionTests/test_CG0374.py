...
RULE_JSON_FILE = "published_rules/CG0374/CG0374.json"
DATASET_PATH = "json_datasets/CG0374/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000384', 1, 'CG0374', None, 'RELREC.RDOMAIN does not represent a dataset present in the study', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
