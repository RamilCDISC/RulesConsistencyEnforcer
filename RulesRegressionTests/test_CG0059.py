...
RULE_JSON_FILE = "published_rules/CG0059/CG0059.json"
DATASET_PATH = "json_datasets/CG0059/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000085', 1, 'CG0059', None, '--STTPT is completed and --STRTPT is empty', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
