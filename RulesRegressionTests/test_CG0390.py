...
RULE_JSON_FILE = "published_rules/CG0390/CG0390.json"
DATASET_PATH = "json_datasets/CG0390/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000125', 1, 'CG0390', None, 'AESDISAB is completed, but not equal to "N" or "Y"', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
