...
RULE_JSON_FILE = "published_rules/CG0039/CG0039.json"
DATASET_PATH = "json_datasets/CG0039/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000264', 1, 'CG0039', None, 'Primary analysis used but --BODSYS and --SOC are not equal', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
