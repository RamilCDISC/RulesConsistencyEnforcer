...
RULE_JSON_FILE = "published_rules/CG0141/CG0141.json"
DATASET_PATH = "json_datasets/CG0141/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000369', 1, 'CG0141', None, 'RFENDTC must be null when ACTARM in (Screen Failure, Not Assigned, Not Treated)', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
