...
RULE_JSON_FILE = "published_rules/CG0211/CG0211.json"
DATASET_PATH = "json_datasets/CG0211/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000095', 1, 'CG0211', None, "ETCD is not 'UNPLAN', when SEUPDES is not empty", 'SKIPPED'], "Mismatch in 'Rules Report', row 0"
