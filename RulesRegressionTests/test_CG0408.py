...
RULE_JSON_FILE = "published_rules/CG0408/CG0408.json"
DATASET_PATH = "json_datasets/CG0408/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000579', 1, 'CG0408', None, 'Dataset has no record.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
