...
RULE_JSON_FILE = "published_rules/CG0027/CG0027.json"
DATASET_PATH = "json_datasets/CG0027/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000237', 1, 'CG0027, SEND43', None, '--SCAT is equal to --CAT', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
