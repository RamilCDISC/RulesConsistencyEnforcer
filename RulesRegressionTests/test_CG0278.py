...
RULE_JSON_FILE = "published_rules/CG0278/CG0278.json"
DATASET_PATH = "json_datasets/CG0278/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000470', 1, 'CG0278', None, 'A record exists in TS where TSPARMCD = STYPE and TSVAL = INTERVENTIONAL but TSVAL for TSPARMCD = INTTYPE is empty.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
