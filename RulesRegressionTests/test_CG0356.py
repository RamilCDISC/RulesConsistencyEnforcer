...
RULE_JSON_FILE = "published_rules/CG0356/CG0356.json"
DATASET_PATH = "json_datasets/CG0356/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000174', 1, 'CG0356', None, 'SPECIES is present in DM dataset.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
