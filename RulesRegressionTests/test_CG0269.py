...
RULE_JSON_FILE = "published_rules/CG0269/CG0269.json"
DATASET_PATH = "json_datasets/CG0269/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000372', 1, 'CG0269', None, 'For TS.TSPARMCD = "ADDON" records, TS.TSVAL value must equal "N" or "Y" when not missing', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
