...
RULE_JSON_FILE = "published_rules/CG0388/CG0388.json"
DATASET_PATH = "json_datasets/CG0388/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000123', 1, 'CG0388', None, 'AESCAN is completed, but not equal to "N" or "Y"', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
