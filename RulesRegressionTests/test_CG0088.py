...
RULE_JSON_FILE = "published_rules/CG0088/CG0088.json"
DATASET_PATH = "json_datasets/CG0088/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000015', 1, 'CG0088, TIG0353', None, '--PRESP is missing in dataset when --OCCUR is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
