...
RULE_JSON_FILE = "published_rules/CG0009/CG0009.json"
DATASET_PATH = "json_datasets/CG0009/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000271', 1, 'CG0009', None, 'EPOCH is not in TA.EPOCH', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
