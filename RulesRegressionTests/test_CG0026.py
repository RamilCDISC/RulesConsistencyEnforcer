...
RULE_JSON_FILE = "published_rules/CG0026/CG0026.json"
DATASET_PATH = "json_datasets/CG0026/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000248', 1, 'CG0026, SEND63', 'FB3702', '--RFTDTC is populated when --TPTREF is null', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
