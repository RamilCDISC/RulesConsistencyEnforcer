...
RULE_JSON_FILE = "published_rules/CG0204/CG0204.json"
DATASET_PATH = "json_datasets/CG0204/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000135', 1, 'CG0204, TIG0424', None, 'IDVAR is not empty but IDVARVAL is empty.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
