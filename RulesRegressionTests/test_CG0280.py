...
RULE_JSON_FILE = "published_rules/CG0280/CG0280.json"
DATASET_PATH = "json_datasets/CG0280/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000335', 1, 'CG0280', None, 'TSPARMCD = "RANDQT" but TSVAL is not a number between 0 and 1.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
