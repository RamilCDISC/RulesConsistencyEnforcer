...
RULE_JSON_FILE = "published_rules/CG0627/CG0627.json"
DATASET_PATH = "json_datasets/CG0627/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000054', 1, 'CG0627, TIG0668', None, '--DTHREL is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
