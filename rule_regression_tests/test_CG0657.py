...
RULE_JSON_FILE = "published_rules/CG0657/CG0657.json"
DATASET_PATH = "json_datasets/CG0657/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000036', 1, 'CG0657', None, 'Planned visit is not found in TV.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
