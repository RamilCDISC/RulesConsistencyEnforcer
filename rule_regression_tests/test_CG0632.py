...
RULE_JSON_FILE = "published_rules/CG0632/CG0632.json"
DATASET_PATH = "json_datasets/CG0632/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000059', 1, 'CG0632, TIG0673', None, 'RPPLDY is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
