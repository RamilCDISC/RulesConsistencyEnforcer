...
RULE_JSON_FILE = "published_rules/CG0665/CG0665.json"
DATASET_PATH = "json_datasets/CG0665/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000189', 1, 'CG0665', None, 'AGEU is missing when AGE is provided.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
