...
RULE_JSON_FILE = "published_rules/CG0637/CG0637.json"
DATASET_PATH = "json_datasets/CG0637/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000064', 1, 'CG0637, TIG0678', None, '--RPDY is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
