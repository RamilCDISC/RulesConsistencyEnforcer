...
RULE_JSON_FILE = "published_rules/CG0513/CG0513.json"
DATASET_PATH = "json_datasets/CG0513/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000223', 1, 'CG0513', None, 'ACTARMCD is empty, but ARMNRS is not completed.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
