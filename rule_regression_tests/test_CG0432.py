...
RULE_JSON_FILE = "published_rules/CG0432/CG0432.json"
DATASET_PATH = "json_datasets/CG0432/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000452', 1, 'CG0432', None, 'Missing value for AGEU, when AGE or AGETXT is provided', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
