...
RULE_JSON_FILE = "published_rules/CG0073/CG0073.json"
DATASET_PATH = "json_datasets/CG0073/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000364', 1, 'CG0073', None, 'EPOCH should be null if DSCAT is protocol milestone', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
