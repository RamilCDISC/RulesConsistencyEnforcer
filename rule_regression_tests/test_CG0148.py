...
RULE_JSON_FILE = "published_rules/CG0148/CG0148.json"
DATASET_PATH = "json_datasets/CG0148/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000239', 1, 'CG0148', None, 'RFXSTDTC does not equal the earliest value of EX.EXSTDTC', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
