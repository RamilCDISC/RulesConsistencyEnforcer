...
RULE_JSON_FILE = "published_rules/CG0508/CG0508.json"
DATASET_PATH = "json_datasets/CG0508/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000074', 1, 'CG0508, TIG0603', None, '--IMPLBL is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
