...
RULE_JSON_FILE = "published_rules/CG0058/CG0058.json"
DATASET_PATH = "json_datasets/CG0058/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000171', 1, 'CG0058', None, '--ENTPT should be present when --ENRTPT is present in a dataset', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
