...
RULE_JSON_FILE = "published_rules/CG0569/CG0569.json"
DATASET_PATH = "json_datasets/CG0569/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000105', 1, 'CG0569', None, "--LOBXFL = 'Y', but --STRESC is empty.", 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
