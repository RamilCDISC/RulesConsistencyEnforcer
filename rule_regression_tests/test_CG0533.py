...
RULE_JSON_FILE = "published_rules/CG0533/CG0533.json"
DATASET_PATH = "json_datasets/CG0533/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000073', 1, 'CG0533', None, 'RPATHCD is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
