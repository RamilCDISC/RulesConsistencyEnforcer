...
RULE_JSON_FILE = "published_rules/CG0633/CG0633.json"
DATASET_PATH = "json_datasets/CG0633/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000060', 1, 'CG0633, TIG0674', None, 'RPPLSTDY is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
