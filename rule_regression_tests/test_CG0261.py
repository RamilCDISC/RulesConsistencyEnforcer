...
RULE_JSON_FILE = "published_rules/CG0261/CG0261.json"
DATASET_PATH = "json_datasets/CG0261/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000151', 1, 'CG0261', None, 'TSVAL is null when TSVAL1 is populated.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
