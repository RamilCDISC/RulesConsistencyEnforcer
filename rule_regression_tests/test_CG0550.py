...
RULE_JSON_FILE = "published_rules/CG0550/CG0550.json"
DATASET_PATH = "json_datasets/CG0550/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000295', 1, 'CG0550, TIG0638', None, '--STREFN is null when --STREFC is populated.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
