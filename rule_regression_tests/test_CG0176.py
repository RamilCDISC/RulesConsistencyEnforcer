...
RULE_JSON_FILE = "published_rules/CG0176/CG0176.json"
DATASET_PATH = "json_datasets/CG0176/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000001', 1, 'CG0176', None, 'IECAT equals "INCLUSION" and IEORRES is not equal to "N".', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
