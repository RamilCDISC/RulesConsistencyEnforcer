...
RULE_JSON_FILE = "published_rules/CG0455/CG0455.json"
DATASET_PATH = "json_datasets/CG0455/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000483', 1, 'CG0455', None, "TSPARMCD = PCLAS but TSVCDREF does not equal 'MED-RT'.", 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
