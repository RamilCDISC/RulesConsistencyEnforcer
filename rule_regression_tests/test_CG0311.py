...
RULE_JSON_FILE = "published_rules/CG0311/CG0311.json"
DATASET_PATH = "json_datasets/CG0311/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000019', 1, 'CG0311, SEND3, TIG0211, TIG0486', None, 'Variable label length should be less than or equal to 40 characters', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
