...
RULE_JSON_FILE = "published_rules/CG0153/CG0153.json"
DATASET_PATH = "json_datasets/CG0153/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000010', 1, 'CG0153', None, 'ARMCD value length is greater than 20', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
