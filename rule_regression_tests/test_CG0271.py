...
RULE_JSON_FILE = "published_rules/CG0271/CG0271.json"
DATASET_PATH = "json_datasets/CG0271/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000373', 1, 'CG0271', None, 'For TS.TSPARMCD = "RANDOM" records, TS.TSVAL value must equal "N" or "Y" when not missing', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
