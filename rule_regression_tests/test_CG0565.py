...
RULE_JSON_FILE = "published_rules/CG0565/CG0565.json"
DATASET_PATH = "json_datasets/CG0565/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000112', 1, 'CG0565, TIG0650', None, '--CONC is present in a dataset other than MS.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
