...
RULE_JSON_FILE = "published_rules/CG0339/CG0339.json"
DATASET_PATH = "json_datasets/CG0339/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000197', 1, 'CG0339', None, '--CAT is equal to --BODSYS.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
