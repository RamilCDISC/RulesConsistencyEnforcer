...
RULE_JSON_FILE = "published_rules/CG0642/CG0642.json"
DATASET_PATH = "json_datasets/CG0642/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000069', 1, 'CG0642', None, 'SPECIES is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
