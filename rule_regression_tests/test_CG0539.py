...
RULE_JSON_FILE = "published_rules/CG0539/CG0539.json"
DATASET_PATH = "json_datasets/CG0539/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000215', 1, 'CG0539', None, "There is more than 1 record per subject has DSSCAT = 'STUDY TREATMENT'", 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
