...
RULE_JSON_FILE = "published_rules/CG0624/CG0624.json"
DATASET_PATH = "json_datasets/CG0624/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000051', 1, 'CG0624, TIG0665', None, '--RSTMOD is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
