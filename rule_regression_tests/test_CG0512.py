...
RULE_JSON_FILE = "published_rules/CG0512/CG0512.json"
DATASET_PATH = "json_datasets/CG0512/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000208', 1, 'CG0512', None, 'ACTARMCD is not in in TA.ARMCD', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
