...
RULE_JSON_FILE = "published_rules/CG0641/CG0641.json"
DATASET_PATH = "json_datasets/CG0641/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000068', 1, 'CG0641', None, 'AGETXT is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
