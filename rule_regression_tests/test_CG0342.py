...
RULE_JSON_FILE = "published_rules/CG0342/CG0342.json"
DATASET_PATH = "json_datasets/CG0342/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000160', 1, 'CG0342', None, "--TRT is equal to 'OTHER'", 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
