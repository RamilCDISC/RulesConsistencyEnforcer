...
RULE_JSON_FILE = "published_rules/CG0302/CG0302.json"
DATASET_PATH = "json_datasets/CG0302/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000076', 1, 'CG0302', None, 'TRPORTOT is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
