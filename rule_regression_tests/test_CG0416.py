...
RULE_JSON_FILE = "published_rules/CG0416/CG0416.json"
DATASET_PATH = "json_datasets/CG0416/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000222', 1, 'CG0416, TIG0571', None, 'QLABEL > 40 chars.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
