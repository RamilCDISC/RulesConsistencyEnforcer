...
RULE_JSON_FILE = "published_rules/CG0636/CG0636.json"
DATASET_PATH = "json_datasets/CG0636/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000063', 1, 'CG0636', None, '--NOMLBL is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
