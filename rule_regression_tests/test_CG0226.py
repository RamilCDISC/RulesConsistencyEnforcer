...
RULE_JSON_FILE = "published_rules/CG0226/CG0226.json"
DATASET_PATH = "json_datasets/CG0226/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000262', 1, 'CG0226', None, 'RFSTDTC in DM dataset is empty but --STRF is completed.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
