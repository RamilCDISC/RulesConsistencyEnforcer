...
RULE_JSON_FILE = "published_rules/CG0358/CG0358.json"
DATASET_PATH = "json_datasets/CG0358/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000176', 1, 'CG0358', None, 'SBSTRAIN is present in DM dataset.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
