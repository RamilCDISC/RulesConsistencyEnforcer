...
RULE_JSON_FILE = "published_rules/CG0516/CG0516.json"
DATASET_PATH = "json_datasets/CG0516/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000210', 1, 'CG0516', None, 'ARMCD is not present in TA.ARMCD', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
