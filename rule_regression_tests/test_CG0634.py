...
RULE_JSON_FILE = "published_rules/CG0634/CG0634.json"
DATASET_PATH = "json_datasets/CG0634/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000061', 1, 'CG0634, TIG0675', None, 'RPPLENDY is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
