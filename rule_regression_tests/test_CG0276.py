...
RULE_JSON_FILE = "published_rules/CG0276/CG0276.json"
DATASET_PATH = "json_datasets/CG0276/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000468', 1, 'CG0276', None, 'A record exists in TS where TSPARMCD = STYPE and TSVAL = INTERVENTIONAL but TSVAL for TSPARMCD = TRT is empty.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
