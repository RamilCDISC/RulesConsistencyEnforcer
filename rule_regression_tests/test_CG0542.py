...
RULE_JSON_FILE = "published_rules/CG0542/CG0542.json"
DATASET_PATH = "json_datasets/CG0542/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000072', 1, 'CG0542', None, '--BEATNO is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
