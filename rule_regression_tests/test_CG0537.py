...
RULE_JSON_FILE = "published_rules/CG0537/CG0537.json"
DATASET_PATH = "json_datasets/CG0537/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000374', 1, 'CG0537', None, 'There is more than one record per subject per EPOCH', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
