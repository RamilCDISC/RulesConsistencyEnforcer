...
RULE_JSON_FILE = "published_rules/CG0334/CG0334.json"
DATASET_PATH = "json_datasets/CG0334/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000538', 1, 'CG0334, TIG0500', None, 'RDOMAIN does not match characters 5 and 6 of the dataset name', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
