...
RULE_JSON_FILE = "published_rules/CG0044/CG0044.json"
DATASET_PATH = "json_datasets/CG0044/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000013', 1, 'CG0044', None, 'AESTAT variable is present in AE dataset.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
