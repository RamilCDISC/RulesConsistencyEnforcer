...
RULE_JSON_FILE = "published_rules/CG0119/CG0119.json"
DATASET_PATH = "json_datasets/CG0119/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000530', 1, 'CG0119', None, 'ACTARM should be equal to ARM when ACTARM is Screen Failure or Not Assigned', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
