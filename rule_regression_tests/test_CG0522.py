...
RULE_JSON_FILE = "published_rules/CG0522/CG0522.json"
DATASET_PATH = "json_datasets/CG0522/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000120', 1, 'CG0522', None, 'ACTARM is populated, when ACTARMCD is NULL', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
