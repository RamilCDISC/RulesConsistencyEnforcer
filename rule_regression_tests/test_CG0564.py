...
RULE_JSON_FILE = "published_rules/CG0564/CG0564.json"
DATASET_PATH = "json_datasets/CG0564/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000111', 1, 'CG0564, TIG0649', None, '--AGENT is present in a dataset other than MS.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
