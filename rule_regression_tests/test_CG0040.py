...
RULE_JSON_FILE = "published_rules/CG0040/CG0040.json"
DATASET_PATH = "json_datasets/CG0040/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000012', 1, 'CG0040', None, 'AEOCCUR is present in AE dataset.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
