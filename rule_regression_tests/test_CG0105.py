...
RULE_JSON_FILE = "published_rules/CG0105/CG0105.json"
DATASET_PATH = "json_datasets/CG0105/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000291', 1, 'CG0105', None, 'EXVAMT is present when EC exists.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
