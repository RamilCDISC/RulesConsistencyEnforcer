...
RULE_JSON_FILE = "published_rules/CG0625/CG0625.json"
DATASET_PATH = "json_datasets/CG0625/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000052', 1, 'CG0625', None, '--IMPLBL is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
