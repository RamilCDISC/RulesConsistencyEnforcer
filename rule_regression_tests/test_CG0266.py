...
RULE_JSON_FILE = "published_rules/CG0266/CG0266.json"
DATASET_PATH = "json_datasets/CG0266/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000153', 1, 'CG0266', None, 'TSVCDREF is null when TSVCDVER is populated', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
