...
RULE_JSON_FILE = "published_rules/CG0304/CG0304.json"
DATASET_PATH = "json_datasets/CG0304/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000075', 1, 'CG0304', None, 'AEREASND is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
