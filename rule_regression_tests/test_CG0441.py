...
RULE_JSON_FILE = "published_rules/CG0441/CG0441.json"
DATASET_PATH = "json_datasets/CG0441/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000467', 1, 'CG0441', None, 'TSVAL is missing when TSPARMCD = STOPRULE.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
