...
RULE_JSON_FILE = "published_rules/CG0031/CG0031.json"
DATASET_PATH = "json_datasets/CG0031/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000269', 1, 'CG0031', None, "For a planned visit (SVPRESP = 'Y'), non-missing VISIT value must be among those present in TV.VISIT.", 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
