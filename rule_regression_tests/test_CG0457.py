...
RULE_JSON_FILE = "published_rules/CG0457/CG0457.json"
DATASET_PATH = "json_datasets/CG0457/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000338', 1, 'CG0457', None, 'TSPARMCD = ACTSUB but the value provided in TSVAL is not a positive integer.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
