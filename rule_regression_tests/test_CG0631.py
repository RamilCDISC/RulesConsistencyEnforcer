...
RULE_JSON_FILE = "published_rules/CG0631/CG0631.json"
DATASET_PATH = "json_datasets/CG0631/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000058', 1, 'CG0631, TIG0672', None, 'RPHASE is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
