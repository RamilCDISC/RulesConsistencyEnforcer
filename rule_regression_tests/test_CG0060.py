...
RULE_JSON_FILE = "published_rules/CG0060/CG0060.json"
DATASET_PATH = "json_datasets/CG0060/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000261', 1, 'CG0060', None, '--STTPT is present in dataset, but --STRTPT is not present in dataset.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
