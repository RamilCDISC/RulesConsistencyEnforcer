...
RULE_JSON_FILE = "published_rules/CG0343/CG0343.json"
DATASET_PATH = "json_datasets/CG0343/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000161', 1, 'CG0343', None, "--TERM is equal to 'OTHER'", 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
