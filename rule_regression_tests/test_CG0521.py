...
RULE_JSON_FILE = "published_rules/CG0521/CG0521.json"
DATASET_PATH = "json_datasets/CG0521/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000119', 1, 'CG0521', None, 'ARM is populated, when ARMCD is NULL', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
