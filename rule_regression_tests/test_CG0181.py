...
RULE_JSON_FILE = "published_rules/CG0181/CG0181.json"
DATASET_PATH = "json_datasets/CG0181/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000289', 1, 'CG0181', None, 'LBORRES is not a continuous measurement or Empty, when LBORNRHI is not empty.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
