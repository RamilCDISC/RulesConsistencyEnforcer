...
RULE_JSON_FILE = "published_rules/CG0282/CG0282.json"
DATASET_PATH = "json_datasets/CG0282/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000563', 1, 'CG0282', None, 'TSVAL must be either Y or N when TSPARMCD is ADAPT', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
