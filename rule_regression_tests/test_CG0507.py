...
RULE_JSON_FILE = "published_rules/CG0507/CG0507.json"
DATASET_PATH = "json_datasets/CG0507/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000049', 1, 'CG0507, CG0622, TIG0602', None, '--USCHFL is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
