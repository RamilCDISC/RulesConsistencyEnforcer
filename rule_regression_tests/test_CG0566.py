...
RULE_JSON_FILE = "published_rules/CG0566/CG0566.json"
DATASET_PATH = "json_datasets/CG0566/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000113', 1, 'CG0566, TIG0651', None, '--CONCU is present in a dataset other than MS.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
