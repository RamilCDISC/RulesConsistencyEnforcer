...
RULE_JSON_FILE = "published_rules/CG0640/CG0640.json"
DATASET_PATH = "json_datasets/CG0640/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000067', 1, 'CG0640, TIG0681', None, '--DETECT is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
