...
RULE_JSON_FILE = "published_rules/CG0354/CG0354.json"
DATASET_PATH = "json_datasets/CG0354/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000243', 1, 'CG0354', None, '--REASEX must never be used in SDTM-based human clinical trials', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
