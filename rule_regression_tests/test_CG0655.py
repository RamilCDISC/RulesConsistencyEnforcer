...
RULE_JSON_FILE = "published_rules/CG0655/CG0655.json"
DATASET_PATH = "json_datasets/CG0655/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000039', 1, 'CG0655', None, 'VISITNUM for planned visit is not in TV.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
