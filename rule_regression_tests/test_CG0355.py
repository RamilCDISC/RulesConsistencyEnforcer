...
RULE_JSON_FILE = "published_rules/CG0355/CG0355.json"
DATASET_PATH = "json_datasets/CG0355/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000244', 1, 'CG0355, TIG0520', None, '--DETECT must never be used in SDTM-based human trials', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
