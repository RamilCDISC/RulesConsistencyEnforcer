...
RULE_JSON_FILE = "published_rules/CG0079/CG0079.json"
DATASET_PATH = "json_datasets/CG0079/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000236', 1, 'CG0079', None, "MHSTDTC ^= null and MHSTDTC is on or after the DM.RFSTDTC. The medical history dataset should include the subject's prior history at the start of the trial.", 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
