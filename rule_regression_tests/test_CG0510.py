...
RULE_JSON_FILE = "published_rules/CG0510/CG0510.json"
DATASET_PATH = "json_datasets/CG0510/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000245', 1, 'CG0510, TIG0605', None, '--NOMDY is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
