...
RULE_JSON_FILE = "published_rules/CG0209/CG0209.json"
DATASET_PATH = "json_datasets/CG0209/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000527', 1, 'CG0209', None, 'SEENDTC is null when element is not the last.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
