...
RULE_JSON_FILE = "published_rules/CG0363/CG0363.json"
DATASET_PATH = "json_datasets/CG0363/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000231', 1, 'CG0363', None, 'RSUBJID when populated cannot equal USUBJID', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
