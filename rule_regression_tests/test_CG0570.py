...
RULE_JSON_FILE = "published_rules/CG0570/CG0570.json"
DATASET_PATH = "json_datasets/CG0570/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000115', 1, 'CG0570', None, "ARM cannot be equal to 'Screen Failure', 'Not Assigned', 'Unplanned Treatment' or 'Not Treated'.", 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
