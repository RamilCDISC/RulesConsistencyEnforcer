...
RULE_JSON_FILE = "published_rules/CG0638/CG0638.json"
DATASET_PATH = "json_datasets/CG0638/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000065', 1, 'CG0638, TIG0679', None, '--RPSTDY is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
