...
RULE_JSON_FILE = "published_rules/CG0511/CG0511.json"
DATASET_PATH = "json_datasets/CG0511/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000246', 1, 'CG0511, TIG0606', None, '--NOMLBL is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
