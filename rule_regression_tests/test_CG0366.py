...
RULE_JSON_FILE = "published_rules/CG0366/CG0366.json"
DATASET_PATH = "json_datasets/CG0366/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000234', 1, 'CG0366', None, 'RSUBJID must be missing when RDEVID is populated', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
