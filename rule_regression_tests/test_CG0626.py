...
RULE_JSON_FILE = "published_rules/CG0626/CG0626.json"
DATASET_PATH = "json_datasets/CG0626/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000053', 1, 'CG0626', None, '--RESLOC is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
