...
RULE_JSON_FILE = "published_rules/CG0552/CG0552.json"
DATASET_PATH = "json_datasets/CG0552/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000247', 1, 'CG0552, TIG0640', None, '--RESLOC is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
