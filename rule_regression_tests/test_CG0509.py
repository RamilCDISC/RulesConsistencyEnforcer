...
RULE_JSON_FILE = "published_rules/CG0509/CG0509.json"
DATASET_PATH = "json_datasets/CG0509/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000057', 1, 'CG0509, CG0630, TIG0604', None, 'FETUSID is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
