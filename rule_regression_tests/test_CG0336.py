...
RULE_JSON_FILE = "published_rules/CG0336/CG0336.json"
DATASET_PATH = "json_datasets/CG0336/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000272', 1, 'CG0336, SEND46, TIG0501', None, '--CAT is equal to DOMAIN.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
