...
RULE_JSON_FILE = "published_rules/CG0456/CG0456.json"
DATASET_PATH = "json_datasets/CG0456/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000339', 1, 'CG0456', None, "TSPARMCD = FCNTRY but TSVCDREF is not equal to 'ISO 3166-1 alpha-3'", 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
