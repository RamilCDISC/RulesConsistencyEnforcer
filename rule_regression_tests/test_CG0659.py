...
RULE_JSON_FILE = "published_rules/CG0659/CG0659.json"
DATASET_PATH = "json_datasets/CG0659/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000031', 1, 'CG0659', None, '--EVAL is present.  --EVAL must not be used to model QRS data.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
