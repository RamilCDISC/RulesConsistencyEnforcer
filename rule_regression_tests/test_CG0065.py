...
RULE_JSON_FILE = "published_rules/CG0065/CG0065.json"
DATASET_PATH = "json_datasets/CG0065/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000033', 1, 'CG0065', None, 'DSDECOD is not equal to "COMPLETED" when DSTERM equals "COMPLETED".', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
