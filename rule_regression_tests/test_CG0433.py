...
RULE_JSON_FILE = "published_rules/CG0433/CG0433.json"
DATASET_PATH = "json_datasets/CG0433/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000453', 1, 'CG0433', None, 'Missing value for AGE, when AGEU is provided', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
