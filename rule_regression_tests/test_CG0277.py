...
RULE_JSON_FILE = "published_rules/CG0277/CG0277.json"
DATASET_PATH = "json_datasets/CG0277/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000469', 1, 'CG0277', None, 'A record exists in TS where TSPARMCD = STYPE and TSVAL = INTERVENTIONAL but TSVAL for TSPARMCD = INTMODEL is empty.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
