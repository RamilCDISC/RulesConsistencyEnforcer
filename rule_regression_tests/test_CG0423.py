...
RULE_JSON_FILE = "published_rules/CG0423/CG0423.json"
DATASET_PATH = "json_datasets/CG0423/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000100', 1, 'CG0423', None, 'Missing --TRTV value, when --VAMT value is populated.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
