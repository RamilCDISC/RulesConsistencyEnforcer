...
RULE_JSON_FILE = "published_rules/CG0094/CG0094.json"
DATASET_PATH = "json_datasets/CG0094/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000225', 1, 'CG0094, TIG0359', None, '--STAT should be "NOT DONE" when --REASND is provided.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
