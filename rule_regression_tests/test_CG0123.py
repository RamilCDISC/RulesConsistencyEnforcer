...
RULE_JSON_FILE = "published_rules/CG0123/CG0123.json"
DATASET_PATH = "json_datasets/CG0123/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000185', 1, 'CG0123', None, 'Length of ACTARMCD is greater than 20 characters', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
