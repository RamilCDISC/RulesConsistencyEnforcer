...
RULE_JSON_FILE = "published_rules/CG0567/CG0567.json"
DATASET_PATH = "json_datasets/CG0567/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000114', 1, 'CG0567, TIG0652', None, '--EVDTYP is present in a dataset other than MH.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
