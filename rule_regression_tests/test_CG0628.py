...
RULE_JSON_FILE = "published_rules/CG0628/CG0628.json"
DATASET_PATH = "json_datasets/CG0628/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000055', 1, 'CG0628, TIG0669', None, '--EXCLFL is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
