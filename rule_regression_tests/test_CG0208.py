...
RULE_JSON_FILE = "published_rules/CG0208/CG0208.json"
DATASET_PATH = "json_datasets/CG0208/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000002', 1, 'CG0208', None, 'SESTDTC is required.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
