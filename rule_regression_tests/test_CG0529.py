...
RULE_JSON_FILE = "published_rules/CG0529/CG0529.json"
DATASET_PATH = "json_datasets/CG0529/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000191', 1, 'CG0529', None, 'RFENDTC is missing when ARM is provided.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
