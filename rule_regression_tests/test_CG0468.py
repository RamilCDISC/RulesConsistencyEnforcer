...
RULE_JSON_FILE = "published_rules/CG0468/CG0468.json"
DATASET_PATH = "json_datasets/CG0468/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000026', 1, 'CG0468, TIG0598', None, 'The --TPTNUM variable does not exist when --TPT does exist.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
