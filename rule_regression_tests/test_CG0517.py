...
RULE_JSON_FILE = "published_rules/CG0517/CG0517.json"
DATASET_PATH = "json_datasets/CG0517/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000045', 1, 'CG0517', None, 'ARMNRS value is missing when ARMCD value is missing', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
