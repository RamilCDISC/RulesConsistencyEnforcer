...
RULE_JSON_FILE = "published_rules/CG0639/CG0639.json"
DATASET_PATH = "json_datasets/CG0639/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000066', 1, 'CG0639, TIG0680', None, '--RPENDY is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
