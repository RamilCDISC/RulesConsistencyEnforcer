...
RULE_JSON_FILE = "published_rules/CG0061/CG0061.json"
DATASET_PATH = "json_datasets/CG0061/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000257', 1, 'CG0061', 'FB4401', '--STRTPT is completed, but --STTPT is not completed.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
