...
RULE_JSON_FILE = "published_rules/CG0357/CG0357.json"
DATASET_PATH = "json_datasets/CG0357/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000175', 1, 'CG0357', None, 'STRAIN is present in DM dataset.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
