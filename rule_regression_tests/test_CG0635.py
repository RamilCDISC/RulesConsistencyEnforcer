...
RULE_JSON_FILE = "published_rules/CG0635/CG0635.json"
DATASET_PATH = "json_datasets/CG0635/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000062', 1, 'CG0635', None, '--NOMDY is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
