...
RULE_JSON_FILE = "published_rules/CG0519/CG0519.json"
DATASET_PATH = "json_datasets/CG0519/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000046', 1, 'CG0519', None, 'ARMNRS is missing when ARM value is missing', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
