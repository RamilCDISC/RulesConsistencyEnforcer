...
RULE_JSON_FILE = "published_rules/CG0348/CG0348.json"
DATASET_PATH = "json_datasets/CG0348/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000200', 1, 'CG0348, TIG0513', None, "--ORRES cannot be null when --STAT is null or --DRVFL not equal to 'Y'", 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
