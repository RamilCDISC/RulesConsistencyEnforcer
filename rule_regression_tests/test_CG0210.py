...
RULE_JSON_FILE = "published_rules/CG0210/CG0210.json"
DATASET_PATH = "json_datasets/CG0210/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000256', 1, 'CG0210, SEND125.1, TIG0062, TIG0429', None, "Missing value for SEUPDES, when ETCD='UNPLAN'", 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
