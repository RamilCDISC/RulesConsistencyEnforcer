...
RULE_JSON_FILE = "published_rules/CG0536/CG0536.json"
DATASET_PATH = "json_datasets/CG0536/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000213', 1, 'CG0536', None, 'More than one record per subject per DSSCAT per EPOCH', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
