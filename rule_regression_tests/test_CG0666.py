...
RULE_JSON_FILE = "published_rules/CG0666/CG0666.json"
DATASET_PATH = "json_datasets/CG0666/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000190', 1, 'CG0666', None, 'AGE is missing when AGEU is provided.', 'SKIPPED'], "Mismatch in 'Rules Report', row 0"
