...
RULE_JSON_FILE = "published_rules/CG0515/CG0515.json"
DATASET_PATH = "json_datasets/CG0515/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000224', 1, 'CG0515', None, 'ACTARM is empty, but ARMNRS is not completed.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
