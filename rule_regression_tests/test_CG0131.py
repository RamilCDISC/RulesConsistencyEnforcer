...
RULE_JSON_FILE = "published_rules/CG0131/CG0131.json"
DATASET_PATH = "json_datasets/CG0131/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000006', 1, 'CG0131', None, 'DTHFL is not "Y" or null', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
