...
RULE_JSON_FILE = "published_rules/CG0118/CG0118.json"
DATASET_PATH = "json_datasets/CG0118/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000528', 1, 'CG0118', None, 'ACTARM must be Screen Failure, Not Assigned, Not Treated, or Unplanned Treatment when ACTARM value is not in TA', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
