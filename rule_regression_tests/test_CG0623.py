...
RULE_JSON_FILE = "published_rules/CG0623/CG0623.json"
DATASET_PATH = "json_datasets/CG0623/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000050', 1, 'CG0623, TIG0664', None, '--RSTIND is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
