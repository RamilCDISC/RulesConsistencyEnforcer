...
RULE_JSON_FILE = "published_rules/CG0434/CG0434.json"
DATASET_PATH = "json_datasets/CG0434/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000122', 1, 'CG0434', None, 'AGEU not empty, but AGE empty and AGETXT empty', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
