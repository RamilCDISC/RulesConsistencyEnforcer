...
RULE_JSON_FILE = "published_rules/CG0629/CG0629.json"
DATASET_PATH = "json_datasets/CG0629/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000056', 1, 'CG0629, TIG0670', None, '--REASEX is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
