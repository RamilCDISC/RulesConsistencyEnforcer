...
RULE_JSON_FILE = "published_rules/CG0387/CG0387.json"
DATASET_PATH = "json_datasets/CG0387/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000087', 1, 'CG0387', None, 'AESER is completed, but not equal to "N" or "Y"', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
