...
RULE_JSON_FILE = "published_rules/CG0643/CG0643.json"
DATASET_PATH = "json_datasets/CG0643/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000070', 1, 'CG0643', None, 'STRAIN is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
