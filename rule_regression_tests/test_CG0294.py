...
RULE_JSON_FILE = "published_rules/CG0294/CG0294.json"
DATASET_PATH = "json_datasets/CG0294/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000156', 1, 'CG0294', None, 'ARM is not in TA.ARM', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
