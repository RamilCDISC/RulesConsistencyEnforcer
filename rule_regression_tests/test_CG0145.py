...
RULE_JSON_FILE = "published_rules/CG0145/CG0145.json"
DATASET_PATH = "json_datasets/CG0145/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000379', 1, 'CG0145', None, 'RFSTDTC must be null when ACTARM in (Screen failure, Not Assigned, Not Treated)', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
