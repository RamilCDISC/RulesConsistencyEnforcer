...
RULE_JSON_FILE = "published_rules/CG0391/CG0391.json"
DATASET_PATH = "json_datasets/CG0391/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000126', 1, 'CG0391', None, 'AESDTH is completed, but not equal to "N" or "Y"', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
