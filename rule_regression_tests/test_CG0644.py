...
RULE_JSON_FILE = "published_rules/CG0644/CG0644.json"
DATASET_PATH = "json_datasets/CG0644/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000071', 1, 'CG0644', None, 'SBSTRAIN is present.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
