...
RULE_JSON_FILE = "published_rules/CG0244/CG0244.json"
DATASET_PATH = "json_datasets/CG0244/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000371', 1, 'CG0244', None, 'ARM is "Screen Failure", "Not Assigned", "Unplanned Treatment" or "Not Treated"', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
