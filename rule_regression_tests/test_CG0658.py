...
RULE_JSON_FILE = "published_rules/CG0658/CG0658.json"
DATASET_PATH = "json_datasets/CG0658/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000035', 1, 'CG0658', None, 'VISITDY is populated when SVPRESP is null.  VISITDY is the Planned Study Day of a visit. It should not be populated for unplanned visits.', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
