...
RULE_JSON_FILE = "published_rules/CG0458/CG0458.json"
DATASET_PATH = "json_datasets/CG0458/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000564', 1, 'CG0458', None, "TSPARMCD = INDIC or TSPARMCD = TDIGRP but TSVCDREF is not equal to 'SNOMED'.", 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
