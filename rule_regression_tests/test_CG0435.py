...
RULE_JSON_FILE = "published_rules/CG0435/CG0435.json"
DATASET_PATH = "json_datasets/CG0435/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000007', 1, 'CG0435', None, 'DTHFL is not "Y", when DTHDTC is populated', 'SUCCESS'], "Mismatch in 'Rules Report', row 0"
