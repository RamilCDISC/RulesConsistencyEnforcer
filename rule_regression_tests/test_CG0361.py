...
RULE_JSON_FILE = "published_rules/CG0361/CG0361.json"
DATASET_PATH = "json_datasets/CG0361/converted_dataset.json"
...
def test_excel():
    ...
    assert clean_dataframe(new_df_dict['Rules Report']).iloc[0].tolist() == ['CORE-000229', 1, 'CG0361', None, 'POOLID must be null when USUBJID is populated', 'SKIPPED'], "Mismatch in 'Rules Report', row 0"
